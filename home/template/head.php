...
<head>
    ...
    <meta name="description" content="BEL&MA S.A.C CONSTRUCTORA">
    <meta name="author" content="kdon">
    <meta name="keywords" content="BEL&MA S.A.C CONSTRUCTORA">

    <title><?php echo $nombrepagina; ?></title>

    <link rel="preload" href="img/slide-01.jpg" as="image">
    <link rel="preload" href="img/slide-12.jpg" as="image">
    <link rel="preload" href="img/slide-13.jpg" as="image">
    ...
    <link rel="shortcut icon" href="belma.png">
